...
class SubjectConfig(Base):
    ...
    points_for_1_correct_idea_p1 = Column(Numeric(65, 30), nullable=True)
    points_for_2_correct_idea_p1 = Column(Numeric(65, 30), nullable=True)
    points_for_3_correct_idea_p1 = Column(Numeric(65, 30), nullable=True)
    points_for_4_correct_idea_p1 = Column(Numeric(65, 30), nullable=True)
    points_for_a_correct_answers_p2 = Column(Numeric(65, 30), nullable=True)
    points_for_1_correct_idea_p2 = Column(Numeric(65, 30), nullable=True)
    points_for_2_correct_idea_p2 = Column(Numeric(65, 30), nullable=True)
    points_for_3_correct_idea_p2 = Column(Numeric(65, 30), nullable=True)
    points_for_4_correct_idea_p2 = Column(Numeric(65, 30), nullable=True)
    points_for_a_correct_answers_p3 = Column(Numeric(65, 30), nullable=True)
    points_for_1_correct_idea_p3 = Column(Numeric(65, 30), nullable=True)
    points_for_2_correct_idea_p3 = Column(Numeric(65, 30), nullable=True)
    points_for_3_correct_idea_p3 = Column(Numeric(65, 30), nullable=True)
    points_for_4_correct_idea_p3 = Column(Numeric(65, 30), nullable=True)
