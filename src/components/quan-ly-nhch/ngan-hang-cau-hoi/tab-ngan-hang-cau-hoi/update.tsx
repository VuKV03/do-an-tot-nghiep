            ...
            <button
              ...
              onClick={() => {
                ...
                if (from === 'single' && to === 'true_false') {
                  ...
                  // Câu hỏi ban đầu không phải Đúng/Sai nên lúc mở modal statements bị set về [] —
                  // nếu người dùng đổi loại sang Đúng/Sai ngay trong lúc sửa, phải khởi tạo 4 ý
                  // trống ở đây, nếu không khung nhập "Nội dung câu trả lời" sẽ không hiện dòng nào.
                  setStatements(
            ...
            {questionType === 'short' && (
              <div className='mt-2 animate-in fade-in duration-200'>
                ...
                <Form.Item
                  ...
                  name='correctAnswer'
                  // Khớp ràng buộc ở manual-create.tsx — đáp án Trả lời ngắn chỉ chấp nhận số, dấu
                  // '-' (số âm) và dấu ',' (phân tách nhiều đáp án/phần thập phân).
