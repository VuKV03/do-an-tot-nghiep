...
export interface DetailCapDoTuDuyModalProps {
  open: boolean;
  onClose: () => void;
  record?: any;
}

export default function DetailCapDoTuDuyModal({ open, onClose, record }: DetailCapDoTuDuyModalProps) {
