...
export interface CreateCapDoTuDuyModalProps {
  open: boolean;
  onClose: () => void;
  onSave?: (values: any) => void;
}

export default function CreateCapDoTuDuyModal({ open, onClose, onSave }: CreateCapDoTuDuyModalProps) {
    ...
    >
      ...
      >
        ...
        >
          <Form.Item
            name="Ma"
            label={<span className="text-gray-700 font-medium text-[15px]">Mã cấp độ tư duy</span>}
            rules={[{ required: true, message: 'Vui lòng nhập mã cấp độ tư duy' }]}
          >
          ...
          <Form.Item
            name="Ten"
            label={<span className="text-gray-700 font-medium text-[15px]">Tên cấp độ tư duy</span>}
            rules={[{ required: true, message: 'Vui lòng nhập tên cấp độ tư duy' }]}
          >
            <Input placeholder="Nhập" className="h-[42px] text-base" />
          </Form.Item>
          ...
          >
            <TextArea
              rows={4}
              placeholder="Nhập ghi chú cho cấp độ tư duy."
