...
export interface UpdateLoaiHinhCauHoiModalProps {
  open: boolean;
  onClose: () => void;
...
export default function UpdateLoaiHinhCauHoiModal({ open, onClose, onSave, record }: UpdateLoaiHinhCauHoiModalProps) {
